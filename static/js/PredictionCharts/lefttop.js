...
var LeftTopGraph = echarts.init(document.getElementById('LeftTopGraph'), 'dark');
const chartContainer1 = document.getElementById('LeftTopGraph');
...
bgDiv1.style.backgroundImage = 'url(../static/img/ScientificBackground.jpeg)';
bgDiv1.style.backgroundSize = 'cover';
bgDiv1.style.opacity = 0.3; // 设置透明度
bgDiv1.style.filter = 'blur(10px)'; // 设置高斯模糊程度
bgDiv1.style.zIndex = -1; // 设置 z-index 属性，将背景层放在 echarts 图表下面

// 将背景层插入到 echarts 图表所在的 div 中
chartContainer1.insertBefore(bgDiv1, chartContainer1.firstChild);
