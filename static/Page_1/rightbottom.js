 // 假设您有以下外部的 Time 和 Data 数组
    ...
    // 创建一个 div 元素作为背景层
    const bgDiv4 = document.createElement('div');
    bgDiv4.style.position = 'absolute';
    bgDiv4.style.width = '100%';
    bgDiv4.style.height = '100%';
    bgDiv4.style.backgroundImage = 'url(../static/img/ScientificBackground.jpeg)';
    bgDiv4.style.backgroundSize = 'cover';
    bgDiv4.style.opacity = 0.3; // 设置透明度
    bgDiv4.style.filter = 'blur(10px)'; // 设置高斯模糊程度
    bgDiv4.style.zIndex = -1; // 设置 z-index 属性，将背景层放在 echarts 图表下面
